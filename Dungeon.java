...
public class Dungeon {
  ...
  public Room createAdventure(){
   ...
   // Connect the outside to Room 1:
      outside.setSide(Consts.DOWN,r1);
      r1.setSide(Consts.UP,outside);
      entrance = outside;
  ...
  // Connect Rooms 1, 2, & 3:
     r1.setSide(Consts.EAST,r2);
     r2.setSide(Consts.WEST,r1);
     r2.setSide(Consts.EAST,r3);
     r3.setSide(Consts.WEST,r2);
  ...
  // Connect rooms 3, 4, 5, 6, & 7.
     r3.setSide(Consts.EAST,r4);
     r3.setSide(Consts.DOWN,r5);
     r4.setSide(Consts.WEST,r3);
     r4.setSide(Consts.DOWN,r7);
     r5.setSide(Consts.UP,r3);
     r5.setSide(Consts.EAST,r6);
     r6.setSide(Consts.WEST,r5);
     r7.setSide(Consts.UP,r4);
 ...
 // Lets connect them:
    r4.setSide(Consts.NORTH,r8);
    r8.setSide(Consts.SOUTH,r4);
    r8.setSide(Consts.WEST,r9);
    r8.setSide(Consts.EAST,r10);
    r9.setSide(Consts.EAST,r8);
    r10.setSide(Consts.WEST,r8);

 // Create a key and put it in r6:
    Door theDoor = new Door(r10,r11);
    r10.setDoor(Consts.DOWN, theDoor);
    Key theKey = r10.setNewDoor(Consts.DOWN,r11);
    r11.setDoor(Consts.UP,theDoor);
